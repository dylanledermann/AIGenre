...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamFile = channel.stream_unary(
                ...
                request_serializer=proto_dot_inference__pb2.FileChunk.SerializeToString,
                response_deserializer=proto_dot_inference__pb2.EnqueueResponse.FromString,
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamFile': grpc.stream_unary_rpc_method_handler(
                    servicer.StreamFile,
                    request_deserializer=proto_dot_inference__pb2.FileChunk.FromString,
                    response_serializer=proto_dot_inference__pb2.EnqueueResponse.SerializeToString,
            ),
    }
...
class InferenceService(object):
    ...
    def StreamFile(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/InferenceService/StreamFile',
            proto_dot_inference__pb2.FileChunk.SerializeToString,
            proto_dot_inference__pb2.EnqueueResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
